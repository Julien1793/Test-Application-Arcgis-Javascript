    ...
    portalA = new Portal("url portal Vinci autoroutes");
...
//****************************************************************************************************************************************
  ...
  { 
    ...
    SearchPR.addEventListener("click",() => {
      ...
      const url_s = "url API arcgis server Vinci autoroutes geocodage"
  ...
  PrClic.addEventListener("change", () => {
    ...
    const click = view.on("click", function(event) {
      ...
      const url_r = 'url API arcgis server Vinci autoroutes geocodage'
